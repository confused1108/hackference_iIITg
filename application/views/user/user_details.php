        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-9">
                    ...
                    ?>
                        <form class="form-horizontal" method="post" action="<?=CTRL?>User/update_profile">
                            <div class="card-body">
                               ...
                               <!--  <div class="form-group row">
                                    <label for="useridType" class="col-sm-3 text-right control-label col-form-label">ID Type</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="useridType" value="College">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="useridNumber" class="col-sm-3 text-right control-label col-form-label">ID Number</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="useridNumber" value="100">
                                    </div>
                                </div> -->
                                <div class="form-group row">
                                    <label for="designation" class="col-sm-3 text-right control-label col-form-label">Address</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-sm-3 text-right control-label col-form-label">Mail</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="phone" value="<?php echo $val['phone']; ?>">
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="<?=CTRL?>User/change_password">
                            <div class="card-body">
