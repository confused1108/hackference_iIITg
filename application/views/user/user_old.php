                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    foreach ($userdata as $val) {
                                        ?>
                                        <tr>
                                            <td><a href="<?= CTRL ?>User/user_view_old/<?php echo $val['candidate_id']; ?>" style="color:#27a9e3;"><?php echo $val['name']; ?></a></td>
                                            <td><?php echo $val['gender']; ?></td>
                                            <td><?php echo $val['age']; ?></td>
                                            <td><?php echo $val['cname']; ?></td>
                                            <td><?php echo $val['based_on']; ?></td>
                                            <td><?php echo $val['overall_score']; ?></td>
                                            <td><?php echo $val['talent_status']; ?></td>
                                            <td><?php echo $val['timestamp']; ?></td>
                                           
                                            <!--<td><a href="<?= CTRL ?>User/user_assessment_delete/<?php echo $val['candidate_id']; ?>"><i class="fa fa-trash" style="color:red;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= CTRL ?>User/assessment_print/<?php echo $val['assessment_id']; ?>" target="_blank  "><i class="fa fa-print" style="color:#27a9e3;"></i></a></td>-->
											<td style="width:100px;"><a href="<?= CTRL ?>User/user_view_old/<?php echo $val['candidate_id']; ?>" style="color:#27a9e3;"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="delete_prjct(<?php echo $val['candidate_id']; ?>);"><i class="fa fa-trash" style="color:red;"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?= CTRL ?>User/assessment_print/<?php echo $val['assessment_id']; ?>" target="_blank  "><i class="fa fa-print" style="color:#27a9e3;"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?= CTRL ?>User/assessment_edit/<?php echo $val['assessment_id']; ?>" target="_blank  "><i class="fa fa-edit" style="color:#27a9e3;"></i></a></td>
   ...
   var url="<?= CTRL ?>";
    ...
    function delete_prjct(id){
       ...
       var r=confirm("Do you want to delete this?")
        if (r==true)
		window.location.href = url+'User/user_assessment_delete/?id='+id;
