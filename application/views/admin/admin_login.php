    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                <!-- Form -->
                <form class="form-horizontal m-t-20" id="loginform" action="<?=CTRL?>Admin/admin_login_check" method="post">
                    <div class="row p-b-30">
                        <div class="col-12">
                            <h4 id="error" style="text-align: center; color: white;" ></h4>
...
<script>
    $(document).ready(function(){
        if(window.location.hash) {
            $("#error").html("Username & Password are not valid");
        }
    });
</script>
